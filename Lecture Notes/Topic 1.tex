...
The subject in (\ref{RC_speak_dec}) (\emph{the woman who can speak Gaelic}), for example, contains a \keyword{relative clause} (namely \emph{who can speak Gaelic}), which in turn contains constituents, such as its \keyword{direct object} \emph{Gaelic}.
...
\begin{exe}
    ...
    \begin{forest}
        [Sentence
        [Constituent [Constituent] [Constituent] ] [Constituent [Constituent] [Constituent] ] ]
    \end{forest}
    }
    \label{heirarchy}
\end{exe}
