...
\frame{
    \begin{itemize}
        \item Let's talk linguistics: join the Wooclap at \textbf{SYN2A}.
        \item First question: what's a constituent?
...
\pause
    ...
    What's the grammatical yes-no question? What's the \emph{ungrammatical} one that conforms to a simple linear rule?
    \ea
...
\frame{\frametitle{Assessment: Skills-based grading}
    ...
    \bigskip
    \textbf{Office hours:} right after each lecture, DSB 2.23 (Tue 3-4, Thu 2-3, Fri 2-3).
}
