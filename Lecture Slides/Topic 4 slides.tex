...
\frame{
    \begin{itemize}
        \item We're going to start developing our \emph{formal theory} from now on.
...
\frame{
    ...
    \begin{itemize}
        \item The verb \emph{wonder} \textbf{selects for} an NP Agent and a clause Theme.
