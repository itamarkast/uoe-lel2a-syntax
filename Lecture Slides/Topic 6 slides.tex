...
\input{header_beamer}
\subtitle{Topic 6: The X-Bar Schema, Part 2}
...
\frame{
    Last time:
    \ea I \alert{might} \textcolor{blue}{draw} trees slowly.
    \z

    We have an \alert{auxiliary} and a \textcolor{blue}{lexical verb}.

\bigskip
    We'll need to establish the syntactic category of auxiliaries. We could name it anything but standard usage often has it as \obar{I}, short for Inflection; let's see why. \hfill [6a]

\bigskip
    Then we'll see how all the heads and arguments line up properly. \hfill [6b]
}
...
\bigskip
    ...
    \ex \emph{Have}, lexical:
        \ea[]{You have a dog.}
        \ex[*]{Have you \trace{} a dog?}
        \ex[]{Did you have a dog?}
        \z

    \ex \emph{Have}, auxiliary:
...
\frame{
    ...
    Let's try another one. What difference does this minimal pair show?
