...
\frame{\frametitle{Substitution, NP}
    ...
    The intuition: an NP can be replaced by another NP.
\bigskip

    The strongest version of this test: an NP can be replaced by a pronoun.
\bigskip
...
\frame{\frametitle{Movement/questions}
...
\frame{\frametitle{Clefts}
    ...
    \bigskip
    Take a few moments to think of a sentence to test with clefts.
}
...
\frame{\frametitle{Summary}
    ...
    We also discussed:
    \begin{itemize}
        \item Substitution, questions/movement, clefts.
