...
\bigskip
    \begin{forest} for tree={calign=fixed edge angles},
        [\iibar{\alert{X}}
        [specifier] [\ibar{\alert{X}}
        [\obar{\alert{X}}] [complement]]
        ]
    \end{forest}
}
...
\bigskip
    Because we think in terms of \textbf{constituents} (satisfying what's known sometimes as the Projection Principle).
}
