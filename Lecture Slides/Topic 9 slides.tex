...
\input{header_beamer}
\subtitle{Topic 9: Nonfinite clauses}
...
\frame{
    ...
    \ea We seem to have solved the problem.
    \ex They wanted to analyse the sentence.
    \z
}
...
\frame{
    ...
    \ea \uline{We} \fbox{\alert{seem}} \fbox{[to have \uline{\textcolor{blue}{solved}} the problem]}. \hfill [Raising]
    \ex \uline{They} \uline{\alert{wanted}} [to \uline{\textcolor{blue}{analyse}} the sentence]. \hfill [Control]
    \z
}
...
\frame{ \centering
    ...
    Expletive subjects & & \\
    Idiomatic meaning & & \\
    Agent-oriented adverbs & & \\\hline
    Matrix subject & Embedded subject & ``Double'' agent!\\
    \end{tabular}
}
