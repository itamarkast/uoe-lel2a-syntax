% TODO: M3/M4 are always interpreted by students to mean refute their hypothesis, when I think it's fine if they refute a null hypothesis or alternative hypothesis. Not sure how to make this clearer but it's a consistent problem.
% Be clearer on length: 1 page for first draft, a couple more paragraphs for the second draft
% Gloss non-English examples (can refer to the essay instructions)
...
One has a range of properties, including that it allows what we call a \textbf{resultative}:
\ea 
